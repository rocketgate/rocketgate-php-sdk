...
class PurchaseRebillTest extends BaseTestCase
{
...
// $1.99 3-day trial which renews to $9.99/month
        ...
        $this->request->Set(GatewayRequest::AMOUNT(), "1.99");    // bill 1.99 trial now
        $this->request->Set(GatewayRequest::REBILL_START(), "3"); // renew in 3 days
