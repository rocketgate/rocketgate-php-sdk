...
$request->Set(GatewayRequest::PAY_TOKEN(), "4818528860426455");
...
$request->Set(GatewayRequest::PAY_CRYPTOGRAM(), "AzgVPxsAAjN8UR4INaGFMAACAAA=");
$request->Set(GatewayRequest::PAY_CRYPTOGRAM_ECI(), "7");
$request->Set(GatewayRequest::CARD_LAST_FOUR(), "0121");
