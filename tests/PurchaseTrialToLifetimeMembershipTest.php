...
class PurchaseTrialToLifetimeMembershipTest extends BaseTestCase
{
...
//  3-Day Paid Trial @ $2.00, $99.99 Lifetime/Non-Recur
        ...
        $this->request->Set(GatewayRequest::AMOUNT(), "2.00");    // bill 2.00 trial now
        $this->request->Set(GatewayRequest::REBILL_START(), "3");    // Rebill in 3x days
        $this->request->Set(GatewayRequest::REBILL_AMOUNT(), "99.99");    // Rebill at 99.99
        $this->request->Set(GatewayRequest::REBILL_FREQUENCY(), "LIFE"); // Lifetime membership
